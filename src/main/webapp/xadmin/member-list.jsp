...
<%@page import="com.eshop.service.impl.EmployeeServiceImpl"%>
<%@page import="com.eshop.service.EmployeeService"%>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>查询</button>
                        </div>
